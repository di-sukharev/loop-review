...
[`evals/cases.json`](evals/cases.json) captures the expected behavior for clean reviews, high scores with unresolved findings, test trustworthiness, reuse and architecture checks, mixed worktrees, red validation, and loop stagnation.
